...
TARGET_GLOBAL_CPPFLAGS += -mtune=cortex-a8 -mfpu=neon -fno-gcse --param l2-cache-size=512 --param l1-cache-size=64 --param simultaneous-prefetches=6 --param prefetch-latency=400 --param l1-cache-line-size=64
